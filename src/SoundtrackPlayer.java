...
public class SoundtrackPlayer
{
    ...
    public static void playInGametrack1()
    {
        try
        {
            ...
            sound_track_player.setVolume(0.15);  // Adjust volume if necessary
    ...
    public static void playInGametrack3()
    {
        try
        {
            String path = SoundtrackPlayer.class.getResource("/music/level 3 soundtrack.mp3").toExternalForm();
